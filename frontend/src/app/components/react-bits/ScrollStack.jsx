...
const ScrollStack = ({
  ...
  const getElementOffset = useCallback(element => {
    if (useWindowScroll) {
      ...
      const translateY = transform === 'none'
        ? 0
        : new window.DOMMatrixReadOnly(transform).m42;

      return rect.top + window.scrollY - translateY;
    } else {
  ...
  const handleRootScroll = useCallback(() => {
    if (useWindowScroll) handleScroll();
  }, [handleScroll, useWindowScroll]);

  useLenis(handleRootScroll, [handleRootScroll]);
  ...
  return (
    <div className={containerClassName} ref={scrollerRef} style={containerStyles}>
      <div className="scroll-stack-inner min-h-screen px-5 pb-[32rem] pt-[10vh] md:px-20">
        {children}
